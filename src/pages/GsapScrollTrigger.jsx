    ...
    boxes.forEach((box) => {
      gsap.to(box, {
        ...
        scrollTrigger: {
          ...
          start: 'bottom bottom', 
          end: 'top 10%', //increasing the % makes the animation faster
          scrub: true, //smoothens the animation based on scroll position
        },
        ease: 'power1.inOut'
      }); 
    })
  }, { scope: scrollRef }) //scope enables it to know when exactly the animation has to happen
  return (
    <main>
